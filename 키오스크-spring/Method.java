...
import 키오스크.JAVA.dao.BasketDAO;
import 키오스크.JAVA.dao.CustomerDAO;
import 키오스크.JAVA.dao.MenuDAO;
import 키오스크.JAVA.dao.OrderDAO;
import 키오스크.JAVA.vo.BasketVO;
import 키오스크.JAVA.vo.CustomerVO;
import 키오스크.JAVA.vo.MenuVO;
import 키오스크.JAVA.vo.OrderVO;
                ...
                case 3:
                    ...
                    if (orderSel == 3)
                        ...
                        if (milsel == 1) {
                            ...
                            System.out.println("적립 포인트 : " + totalPrice / 100);
                            customerdao.csPointSave(customerName, point);
                            System.out.println(totalPrice / 100 + " 마일리지가 적립되어 총 보유 마일리지 : " + point+ "마일리지");
                        } else {
